...
import com.study.mall.util.PageInfo;
import com.study.vip.mall.search.mapper.SkuSearchMapper;
import com.study.vip.mall.search.model.SkuEs;
import com.study.vip.mall.search.service.SkuSearchService;
import com.study.vip.mall.search.util.HighlightResultMapper;
...
public class SkuSearchServiceImpl implements SkuSearchService {
    ...
    public NativeSearchQueryBuilder queryBuilder(Map<String, Object> searchMap){
        ...
        if(searchMap !=null && searchMap.size()>0){
            ...
            //价格区间查询 price=0-500元 500-100元 1000元以上
            ...
            if(!StringUtils.isEmpty(sfield) && !StringUtils.isEmpty(sm)){
                builder.withSort(SortBuilders.fieldSort(sfield.toString())
